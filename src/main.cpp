...
enum {
    Cmd_DrawTriangle = 0x0
};

// Pre-calculate W = 1.0f in s16.16, we seperate this into integer and fractional parts later
...
int main()
{
    ...
    rspq_block_begin();
    rdpq_write(-1, rsp_example_id, Cmd_DrawTriangle, PhysicalAddr(&triangle_vertices[0])); // Hardcoded triangle, nothing fancy
